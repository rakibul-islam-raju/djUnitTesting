...
class TestViews(TestCase):
    ...
    def test_post_detail_POST_add_new_expense(self):
    ...
    def test_post_detail_POST_no_data(self):
        ...
        self.assertEquals(response.status_code, 302)
        self.assertEquals(project0.expenses.count(), 0)
    ...
    def test_project_create_POST(self):
        response = self.client.post(self.add_url, {
            'name': 'project2',
            'budget': 100000,
            'categoriesString': 'category2,category3'
        })
        ...
        self.assertEquals(category3.project, project2)
